define([ 'angular', 'angular-ui-router', 'controllers/index', 'services/user'], function(angular) {

  var indexModule = angular.module('indexModule', [ 'controller', 'service', 'ui.router' ], angular.noop);
